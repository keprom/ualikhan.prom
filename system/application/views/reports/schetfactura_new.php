...
<tr align="center">
	...
	<TD width="400px"><?php echo $product_name;?> за <?php echo datetostring2($schetfactura_date->date);?> </td>
...
<br />
 ...
 <table width="100%">
 <tr>
 <td align="left"><b>Директор<br/><?php  echo trim($org->director); ?></b></td>
 <td></td>
 ...
 <!--
 <tr>
 <td align="left"><b>Ответственный на подписание<br/>за Руководителя:</b> <?php echo "Нуралин А.А. "; ?> </td>
 <td></td>
 <td align="right"></td>
 </tr>
...
<tr>
 ...
 <!--
<tr>
 <td align="left"><b>Ответственный на подписание<br/>за Гл.Бухгалтера:</b> <?php echo "Шайхимова Д.Е. "; ?> </td>
 <td></td>
 <td align="right"></td>
 </tr>
